  ...
  return (
    <div className="border-b pb-8">
          ...
          {[
            ...
            >
              <Link
                href={href}
                target="_blank"
                className="opacity-70 dark:hover:opacity-100 hover:opacity-100 dark:opacity-70 transition"
              >
                <Image
                  src={src}
                  alt={alt}
      ...
      <motion.p
        ...
        className="mt-8 px-4 text-lg font-medium text-gray-700 dark:text-gray-300"
      >
